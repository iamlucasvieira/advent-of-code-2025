...
from advent_of_code_2025 import day01, day02, day03, day04, day05, day06, day07, day08, day09
...
TEST_CASES: list[AocTest] = [
    ...
    AocTest(
        test_file=InputFile(day=6, is_example=True, version_controlled=False),
        function=day06.part2,
        expected=3263827,
    ),
    AocTest(
        test_file=InputFile(day=6, is_example=False, version_controlled=False),
        function=day06.part2,
        expected=9029931401920,
    ),
    AocTest(
        test_file=InputFile(day=7, is_example=True, version_controlled=False),
        function=day07.part1,
        expected=21,
    ),
    AocTest(
        test_file=InputFile(day=7, is_example=False, version_controlled=False),
        function=day07.part1,
        expected=1711,
    ),
    AocTest(
        test_file=InputFile(day=7, is_example=True, version_controlled=False),
        function=day07.part2,
        expected=40,
    ),
    AocTest(
        test_file=InputFile(day=7, is_example=False, version_controlled=False),
        function=day07.part2,
        expected=36706966158365,
    ),
    AocTest(
        test_file=InputFile(day=8, is_example=True, version_controlled=False),
        function=lambda input_data: day08.part1(input_data, num_connections=10),
        expected=40,
    ),
    AocTest(
    ...
    AocTest(
        test_file=InputFile(day=9, is_example=True, version_controlled=False),
